...
RSpec.describe Child do
  ...
  it 'can be created with a proxy' do
    expect { described_class.create!(proxy:) }.not_to raise_error
  end

  it 'has a guid' do
    expect(described_class.create!(proxy:)).to respond_to(:guid)
  end
